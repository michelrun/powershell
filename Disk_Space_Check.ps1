...
# To run thsi script : powershell.exe -command “& ‘C:\My Scripts\disk_space_check.ps1’ ‘C:\My Scripts\list_machine.txt’ “
#
#########################################################
 
$users = "ctg@sfr.fr" # List of users to email your report to (separate by comma)
$fromemail = "ctg@sfr.fr"
$server = "smtp.sfr.fr" #enter your own SMTP server DNS name / IP address here
